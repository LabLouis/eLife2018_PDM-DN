...
dirout='/Users/agomez/Desktop/supplementary/online/';
%
% Create a new folder directory to save the data 
date=datestr(clock,'mmm.dd,yyyy HH.MM.SS');
dirdest = fullfile('/Users/agomez/Desktop/supplementary/online/',date,'onlineData');
mkdir(dirdest);
cd(dirdest);
...
tic
i=0;
t = timer('TimerFcn','trackgo','period',period,'ExecutionMode','fixedRate','BusyMode','queue','TaskstoExecute',nframe,'ErrorFcn','trackerror');

...
% ------------------------------------------------------------------------
% Directories
outDir='/Users/itastekin/Desktop/masaustu/pure paraffin 1994/(10) ywxTNT, (pure oil) (03.08.)/Aug.09,2016 14.49.14 (small)/';
dataDir=strcat(outDir,'onlinedata/');
cd(dataDir);

% ------------------------------------------------------------------------
% Time resolution
fs=5; % frames per second
% ------------------------------------------------------------------------
...
close all
figure,
tspan=5; % to regulate the speed of the animation
